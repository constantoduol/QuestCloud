...
var ui={
 ...
 closeable : function(el,areaId,callback){
 ...
 dropdown : {
    ...
    populate : function(selectbox,arrayoptions,arrayvalues){
       if(arrayvalues==null || arrayvalues=="undefined"){
            return;  
       }
       for(var y=0; y<arrayvalues.length; ++y){
    	   var text = arrayoptions[y];
    	   var value = arrayvalues[y];
